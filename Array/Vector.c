...
{   
    ...
    Vector_int_display_values(vec2);
    Vector_int_display_values(vec3);
    Vector_int_display_values(vec4);
    Vector_int_display_values(vec5);
    Vector_int_display_values(vec6);
